...
def quat_from_vec1_to_vec2(v1, v2):
    """
    Compute a quaternion that rotates from vector v1 to vector v2.

    Args:
        v1 (np.array): Starting position (x, y, z)
        v2 (np.array): Target position (x, y, z)

    Returns:
        np.array: Quaternion (x, y, z, w) representing the rotation
    """
    v1 = unit_vector(v1)
    v2 = unit_vector(v2)
