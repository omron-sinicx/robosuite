...
# Load model and data
model = mujoco.MjModel.from_xml_path("ctrl_circles_cloth.xml")
...
# Get body IDs
left_bid = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_BODY, "left1")
