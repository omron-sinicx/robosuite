...
# Load model and data
model = mujoco.MjModel.from_xml_path("ctrls_circles_cloth12.xml")
...
with viewer.launch_passive(model, data) as v:
    ...
    for i in range(10000000):
        ...
        # pairs = [(1, 27), (2, 28), (3, 29), (4, 30)] # 36 degree
        # pairs = [(1, 26), (2, 27), (3, 28), (4, 29), (5, 30)] # 48 degree
        # pairs = [(1, 25), (2, 26), (3, 27), (4, 28), (5, 29), (6, 30)] # 60 degree
        pairs = [(1, 24), (2, 25), (3, 26), (4, 27), (5, 28), (6, 29), (7, 30)] # 72 degree
        # pairs = [(1, 23), (2, 24), (3, 25), (4, 26), (5, 27), (6, 28), (7, 29), (8, 30)] # 84 degree
        # pairs = [(1, 22), (2, 23), (3, 24), (4, 25), (5, 26), (6, 27), (7, 28), (8, 29), (9, 30)] # 96 degree
        # pairs = [(1, 21), (2, 22), (3, 23), (4, 24), (5, 25), (6, 26), (7, 27), (8, 28), (9, 29), (10, 30)] # 108 degree
        # pairs = [(1, 20), (2, 21), (3, 22), (4, 23), (5, 24), (6, 25), (7, 26), (8, 27), (9, 28), (10, 29), (11, 30)] # 120 degree
        # pairs = [(1, 19), (2, 20), (3, 21), (4, 22), (5, 23), (6, 24), (7, 25), (8, 26), (9, 27), (10, 28), (11, 29), (12, 30)] # 132 degree
        # pairs = [(1, 18), (2, 19), (3, 20), (4, 21), (5, 22), (6, 23), (7, 24), (8, 25), (9, 26), (10, 27), (11, 28), (12, 29), (13, 30)] # 144 degree
