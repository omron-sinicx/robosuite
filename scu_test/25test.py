...
# Load model and data
model = mujoco.MjModel.from_xml_path("ctrls_circles_cloth14.xml")
...
with viewer.launch_passive(model, data) as v:
    ...
    for i in range(10000000):
        ...
        # pairs = [(1,13), (2,14), (3,15), (4, 16), (17,29), (18,30), (19,31), (20, 32), (33,45), (34,46), (35,47), (36, 48), (49, 61), (50, 62), (51, 63), (52, 64)]

        pairs = [(17,29), (18,30), (19,31), (20, 32), (33,45), (34,46), (35,47), (36, 48), (49, 61), (50, 62), (51, 63), (52, 64)]
